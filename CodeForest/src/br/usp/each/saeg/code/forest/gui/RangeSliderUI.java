...
class RangeSliderUI extends BasicSliderUI {
    ...
    private void paintLowerThumb(Graphics g) {
        ...
        synchronized (slider) {
            RangeSlider localSlider = (RangeSlider) slider;
            g2d.setColor(CodeGeometry.createColor(localSlider.getValue()/100f));
            g2d.fill(thumbShape);
    ...
    private void paintUpperThumb(Graphics g) {
        ...
        synchronized (slider) {
            RangeSlider localSlider = (RangeSlider) slider;
            g2d.setColor(CodeGeometry.createColor(localSlider.getUpperValue()/100f));
            g2d.fill(thumbShape);
